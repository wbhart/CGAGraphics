...
cga_fire_more_rand:
   ...
   mov si, 16192          ; copy random values just below visible screen
   mov cx, 80
cga_fire_rand_loop:
   mov al, es:[di+bp]
   mov [si], al
...
cga_fire_loop50:
   ...
   sub bp, 2
   mov dl, [di+bp]    ; setup al, ah, bl, bh, dl
   inc bp
   and dl, 15
   mov bl, [di+bp]
   inc bp
