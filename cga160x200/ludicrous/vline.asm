...
_cga_draw_vline PROC
   ...
   shr ah, 1            ; put solid colour in ah  
   salc
   and al, 055h
   shr ah, 1
   sbb ah, ah
   ...
   mov al, 0f0h         ; colour (ah) and mask (dl) into correct bitfields
   xor al, cl
   and ah, al
   not al
   ...
   add di, sp           ; jump to next odd line
...
vline_even:             ; display pixels on even lines (unroll by 8)
   ...
   add di, sp           ; jump to next even line
