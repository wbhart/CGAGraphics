...
line_hd_even_no_iter:
   ...
   dec cl
   jnz line_hd_not0
   jmp line_hd_no_iter0_no_restore
line_hd_not0:
...
line_hd_even:
   ...
   cli
   mov cs:[sp_save], sp
   mov sp, 0ffb0h       ; store xor constant in sp
...
line_vd_even:
   ...
   jmp line_vd_no_iter_no_restore
...
line_vu_even:
   ...
   jmp line_vu_no_iter_no_restore
...
line_hu_even_no_iter:
   ...
   dec cl
   jnz line_hu_not0
   jmp line_hu_no_iter0_no_restore
line_hu_not0:
