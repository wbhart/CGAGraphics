...
_cga_draw_triangle_1u2d ENDP
   ...
   PUBLIC _cga_draw_triangle_1u2d_l
_cga_draw_triangle_1u2d_l PROC
   ARG buff:DWORD, x:WORD, y:WORD, incs:WORD, len:WORD, colour:BYTE
   ; draw a filled triangle with top point at (x, y), with bottom coords on
   ; the same line and increments in the x direction in inc[i] and (inc+200)[i]
   ; blank left side
...
trifill_1u2d_l_skip_loop:      ; lines of length 0 skipped   
   cmp al, dl
   jbe trifill_1u2d_l_first
...
trifill_1u2d_l_short_loop:
trifill_1u2d_l_first:
   ...
   dec dl               ; if first and last pixels are not in the same byte
   jns trifill_1u2d_l_long_line
trifill_1u2d_l_short_line:
...
trifill_1u2d_l_long_loop:
   ...
   dec dx
   js trifill_1u2d_l_short_line

trifill_1u2d_l_long_line:
   dec di               ; blank byte before line
   mov BYTE PTR es:[di], 0
   inc di
   ...
   mov cx, dx
   shr cx, 1
   jnc trifill_1u2d_l_even_iter
   stosb
trifill_1u2d_l_even_iter:
   rep stosw
   ...
   pop bp
   ret
_cga_draw_triangle_1u2d_l ENDP

   PUBLIC _cga_draw_triangle_1u2d_r
_cga_draw_triangle_1u2d_r PROC
   ARG buff:DWORD, x:WORD, y:WORD, incs:WORD, len:WORD, colour:BYTE
   ; draw a filled triangle with top point at (x, y), with bottom coords on
   ; the same line and increments in the x direction in inc[i] and (inc+200)[i]
   push bp
...
trifill_1u2d_r_skip_loop:      ; lines of length 0 skipped   
   cmp al, dl
   jbe trifill_1u2d_r_first
...
trifill_1u2d_r_short_loop:
trifill_1u2d_r_first:
   ...
   dec dl               ; if first and last pixels are not in the same byte
   jns trifill_1u2d_r_long_line
trifill_1u2d_r_short_line:

   and bh, bl           ; compute overlapped mask and put masked colour in al
   and al, bh
   not bl
   ...
   mov BYTE PTR es:[di], 0 ; blank byte after line
...
trifill_1u2d_r_long_loop:
   ...
   dec dx
   js trifill_1u2d_r_short_line

trifill_1u2d_r_long_line:
   and al, bh           ; put left hand mask in bh and colour in al
   not bh
   ...
   mov cx, dx
   shr cx, 1
   jnc trifill_1u2d_r_even_iter
   stosb
trifill_1u2d_r_even_iter:
   rep stosw
   ...
   pop bp
   ret
_cga_draw_triangle_1u2d_r ENDP

   PUBLIC _cga_draw_triangle_1u2d_b
_cga_draw_triangle_1u2d_b PROC
   ARG buff:DWORD, x:WORD, y:WORD, incs:WORD, len:WORD, colour:BYTE
   ; draw a filled triangle with top point at (x, y), with bottom coords on
   ; the same line and increments in the x direction in inc[i] and (inc+200)[i]
   ; blank left side
...
trifill_1u2d_b_skip_loop:      ; lines of length 0 skipped   
   cmp al, dl
   jbe trifill_1u2d_b_first
...
trifill_1u2d_b_short_loop:
trifill_1u2d_b_first:
   ...
   dec dl               ; if first and last pixels are not in the same byte
   jns trifill_1u2d_b_long_line
trifill_1u2d_b_short_line:
...
trifill_1u2d_b_long_loop:
   ...
   dec dx
   js trifill_1u2d_b_short_line

trifill_1u2d_b_long_line:
   dec di               ; blank byte before line
   mov BYTE PTR es:[di], 0
   inc di
   ...
   mov cx, dx
   shr cx, 1
   jnc trifill_1u2d_b_even_iter
   stosb
trifill_1u2d_b_even_iter:
   rep stosw
   ...
   pop bp
   ret
_cga_draw_triangle_1u2d_b ENDP
